...
1. **$\textcolor{cyan}{MariaDB\ OFRECE\ MEDIDAS\ DE\ SEGURIDAD\ MÁS\ ESTRICTAS}$**  
...
2. **$\textcolor{cyan}{EL\ RENDIMIENTO\ ES\ MÁS\ RÁPIDO\ Y\ MÁS\ EFICIENTE}$**  
...
3. **$\textcolor{cyan}{OBTENDRÁ\ ACCESO\ A\ UNA\ MEJOR\ ASISTENCIA\ AL\ USUARIO}$**  
...
#### **$\textcolor{cyan}{¿QUÉ\ ES\ HEIDI\ SQL?}$**  
...
#### **$\textcolor{cyan}{CONFIGURACIÓN\ DE\ HEIDI\ SQL}$**  
...
#### **$\textcolor{cyan}{CONFIGURACIÓN\ DE\ DATAGRIP}$**  
...
### **$\textcolor{cyan}{CONCLUSIÓN\ SERGIO\ MAYO:}$**  
...
### **$\textcolor{cyan}{CONCLUSIÓN\ ÁLVARO\ FERNÁNDEZ:}$**  
...
### **$\textcolor{cyan}{CONCLUSIÓN\ PABLO\ DÍAZ:}$**  
...
### **$\textcolor{cyan}{CONCLUSIÓN\ FRANCISCO\ MONTILLA:}$**  
> _"En este proyecto he sacado varias conclusiones relacionadas a temas distintos.**Git y github**: De estas herramientas he conocido su uso (tanto Markdow como los repositorios y las ramas) y la versatilidad que nos dan a la hora de realizar proyectos conjuntos, si que me hubiera gustado no tener tantos problemas con ellas y pienso seguir aprendiendo de estas y mejorando con ellas. **MySQL** con este software he aprendido a configurar una base de datos y los parámetros a tener en cuenta antes de escribir el cógigo, como conocer los tipos de datos de la base de datos concreta o la administración de usuarios, permisos y bases de datos. Por último, la coordinación y el trabajo en equipo para repartirnos el trabajo de manera equitativa ha sido una de las claves para el éxito en un proyecto así, en el cual cada uno hemos ido descubriendo cada herramienta por separado y luego puesto en conjunto lo aprendido. Ha sido un trabajo muy interesante y me gustaría seguir trabajando con git y más herramientas nuevas en un futuro."_  
